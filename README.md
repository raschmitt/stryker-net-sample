...
This is a sample project that shows the use of [Stryker .Net](https://github.com/stryker-mutator/stryker-net) to run mutation tests in .Net Core, if you are looking for more information on Stryker itself or what mutaion tests can do for you please refer to their [offcial website](https://stryker-mutator.io/).
